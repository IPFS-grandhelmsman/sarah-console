            ...
            <div class="contain-jdtj-block">
                ...
                <div style="padding-left: 90px;">
                    <table class="contain-statistic-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["total"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["cpu_cores"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["avg_cpu_cores"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["ram_kb"]?>KB&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["ram_str"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["disk_kb"]?>KB&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["disk_str"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["updated_time"]?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="contain-jdtj-block">
                ...
                <div style="padding-left: 90px;">
                    <table class="contain-statistic-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["avg_loadavg"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["ram_used_kb"]?>&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["ram_used_str"]?>, <?php echo $this->_symbol["stat"]["ram_used_percent"]?>%</td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["disk_used_kb"]?>&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["disk_used_str"]?>, <?php echo $this->_symbol["stat"]["disk_used_percent"]?>%</td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["incoming_db"]?>B/sec&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["incoming_db_str"]?></td>
                                <td class="text-center"><?php echo $this->_symbol["stat"]["outgoing_bd"]?>B/sec&nbsp;≈&nbsp;<?php echo $this->_symbol["stat"]["outgoing_bd_str"]?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
