...
<body>
    ...
    <!--<?php print_r($this->_symbol["profile"])?> -->
    <div class="main-contaim">
        <div class="node-title">
            <img class="node-title-img" src="/static/image/dark/icon-set-black.png" alt="用户设置">
            <span>用户设置</span>
        </div>
        <div style="margin-left: 50px;">
            <div class="node-title">
                <img class="node-title-img" src="/static/image/dark/icon-basic-info.png" alt="基本信息">
                <span>基本信息</span>
            </div>
            <div class="set-input clearfix">
                <div class="clearfix">
        ...
        <div style="margin-left: 50px;">
            <div class="node-title">
                <img class="node-title-img" src="/static/image/dark/icon-pwd.png" alt="密码">
                <span>密码修改</span>
            </div>
            <div class="set-input clearfix">
                <div class="clearfix">
