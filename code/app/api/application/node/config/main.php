<?php
/**
 * Application node config API controller
 * 
 * 
*/
...
class ConfigController extends Session_Controller
{    

    /*
     * Application node config edit
    */
    public function actionEdit($input)
    {
        assert_std_tias($input, 'app.node.list', $appnode_id);
        ...
        if ( model('ApplicationNodeSharding')->update($data, $where) == false ) {
