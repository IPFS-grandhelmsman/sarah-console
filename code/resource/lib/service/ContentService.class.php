...
class ContentService extends Service
{
    ...
    */
     ...
     * get the data model
    */
    protected function get_data_model($dataModel, $input)
    {
        ...
        if ( $dataModel == null ) {
            throw new Exception("NULL data model error");
        }

        if ( is_string($dataModel) ) {
            $this->_dataModelObj = model($dataModel);
        } else {
            $this->_dataModelObj = $dataModel;
        }
    ...
    */
    public function _list($input)
    {
        ...
        $model = $this->get_data_model($this->dataModel, $input);
    ...
    */
    ...
    /**
     * model data row default handler
     *
     * @param   $input
     * @param   Mixed(Array or false for failed)
    */
    public function row($input)
    {
        $model = $this->get_data_model($this->dataModel, $input);
        $data  = $this->getData(
            $input, $model, $this->pre_where($input)
        );
